...
// };
    ...
    window.METRO_LOCALES = {
        ...
        'fr': {
            months: [
                "Janvier", "F�vrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novembre", "D�cembre",
                "Jan", "F�v", "Mars", "Avr", "Mai", "Juin", "Juil", "Août", "Sept", "Oct", "Nov", "D�c"
            ],
            days: [
        ...
        'ua': {
            ...
            buttons: [
                "Сьогодні", "Очи�?тити", "Ска�?увати", "Допомога", "�?азад", "Вперед", "Готово"
            ]
        },
        'ru': {
            months: [
            ...
            days: [
                "Во�?кре�?енье", "Понедельник", "Вторник", "Среда", "Четверг", "П�?тница", "Суббота",
                "В�?", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб"
            ],
            buttons: [
                "Сегодн�?", "Очи�?тить", "Отменить", "Помощь", "�?азад", "Вперед", "Готово"
            ]
        },
        ...
        'cs': {
            months: [
                ...
                "Led", "Ún", "Bř", "Dub", "Kvě", "Če", "Čer", "Srp", "Z�", "Ří", "Li", "Pro"
            ],
            days: [
            ...
            buttons: [
                "Dnes", "Vy�?istit", "Zrušit", "Pomoc", "Předešlý", "Další", "Dokon�?it"
            ]
        },
        /* By Satit Rianpit <rianpit@gmail.com> */
        'th': {
            months: [
                "ม�?ราคม", "�?ุมภาพันธ์", "มีนาคม", "เมษายน", "พฤษภาคม", "มิถุนายน", "�?ร�?ฎาคม", "สิงหาคม", "�?ันยายน", "ตุลาคม", "พฤศจิ�?ายน", "ธันวาคม",
                "ม.ค.", "�?.พ.", "มี.ค.", "เม.ย.", "พ.ค.", "มิ.ย.", "�?.ค.", "ส.ค.", "�?.ย.", "ต.ค.", "พ.ย.", "ธ.ค."
            ],
            days: [
                "อาทิตย์", "จันทร์", "อังคาร", "พุธ", "พฤหัสบดี", "ศุ�?ร์", "เสาร์",
                "อา.", "จ.", "อ.", "พ.", "พฤ.", "ศ.", "ส."
            ],
            buttons: [
                "วันนี้", "ล้าง", "ย�?เลิ�?", "ช่วยเหลือ", "�?ลับ", "ต่อไป", "เสร็จ"
            ]
        },
        'id': {
            months: [
